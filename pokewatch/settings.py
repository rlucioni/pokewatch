...
SECRET_KEY = os.environ.get('POKEWATCH_SECRET_KEY', 'insecure-secret-key')
...
WSGI_APPLICATION = 'pokewatch.wsgi.application'
...
DATABASES = dict({}, default=db_config)
